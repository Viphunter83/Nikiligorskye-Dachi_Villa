...
// Full migrated content from data/house-data.ts
const FULL_HOUSE_DATA = {
    Meta: {
        Project_Name: {
...
async function main() {
    ...
    const house = await prisma.houseProfile.upsert({
        ...
        update: {
            features_json: {
                Specs: FULL_HOUSE_DATA.Specs,
                Meta: FULL_HOUSE_DATA.Meta
            },
            cms_data: FULL_HOUSE_DATA.Content
        },
        create: {
            slug: "nikologorskie",
            headline_family: FULL_HOUSE_DATA.Content.Target_Family.Headline.ru,
            headline_investor: FULL_HOUSE_DATA.Content.Target_Investor.Headline.ru,
            headline_party: FULL_HOUSE_DATA.Content.Target_Party.Headline.ru,
